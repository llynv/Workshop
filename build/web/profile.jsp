...
<div class="w3-top">
    <div class="w3-bar w3-white w3-card" id="myNavbar">
        ...
        <div class="w3-right w3-hide-small">
            <a href="/main_controller?action=logout" class="w3-bar-item w3-button">Logout</a>
        </div>
...
<div class="w3-container">
    ...
    <form class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" action="/main_controller?action=profile" method="post">
