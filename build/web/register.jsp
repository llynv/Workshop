...
<header class="bgimg-1 w3-display-container w3-grayscale-min">
  <div class="w3-display-middle">
    <div class="register-container w3-card-4">
      <h2 class="w3-center">Register</h2>
      <form action="/main_controller?action=register" method="post">
        ...
        <p class="w3-center">Already have an account? <a href="/main_controller?action=login">Login here</a>.</p>
      </form>
    </div>
  </div>
</header>
